...
public class DevServerRunner extends UnicastRemoteObject implements DevServerManager {
    ...
    public static DevServerInfo start(String[] classPathEntries, DevServerConfiguration options,
            DevServerRunnerLog log) throws IOException {
        ...
        daemonThread("TeaVM devserver stdout", new ProcessOutputWatcher(stdoutReader, log::info)).start();
        daemonThread("TeaVM devserver stderr", new ProcessOutputWatcher(stderrReader, log::error)).start();
